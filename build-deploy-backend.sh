...
docker tag com.opcode.mern-stack-front-to-back docker-registry.k8s.lan:30501/com.opcode.mern-stack-front-to-back:$tag

docker push docker-registry.k8s.lan:30501/com.opcode.mern-stack-front-to-back:$tag
